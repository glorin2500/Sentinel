            ...
            >
                ...
                <form onSubmit={handleScan} className="bg-zinc-900 p-6 rounded-2xl border border-white/10 space-y-4">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full py-3 bg-primary text-black font-black rounded-lg hover:opacity-90 disabled:opacity-50 transition-all flex items-center justify-center gap-2"
                    >
                        {loading ? (
                            <>
